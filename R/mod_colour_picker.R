...
mod_colour_picker_ui <- function(id) {
  ns <- NS(id)
...
#' colour_picker Server Functions
#'
...
# mod_colour_picker_ui("colour_picker_1")

## To be copied in the server
# mod_colour_picker_server("colour_picker_1")
